...
private:
	Vector3 adaptiveAntialiasing(Ray& ray, Vector3& A, Vector3& B, Vector3& C, Vector3& D, Vector3& E,
		int depth, int maxDepth, Vector3 horizontal, Vector3 vertical, Vector3& backgroundColor, std::vector<Primitive*> primitives) const;
...
public:
	...
	void renderScene(std::vector<Primitive*> primitives, const bool useAntialiasing = true) const;
};